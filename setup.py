...
setup(
    ...
    data_files = [
      ...
      ('/usr/bin/', ['files/usr/bin/container-stop.sh', 'files/usr/bin/container-start.sh', 'files/usr/bin/container-deploy.sh', 'files/usr/bin/eduroam-login.sh', 'files/usr/bin/vm-deploy.sh', 'files/usr/bin/vm-start.sh']),
